...
Buscar explicación chatgptience
"""
...
El tráfico es “plano” → no hay ráfagas ni tiempos de espera muy largos.

✅ Adecuada para: probar el sistema de forma controlada, tráfico simple y balanceado.

2. Poisson (discreta, con enteros ≥ 0)

Cómo funciona: cada interarrival se genera con una distribución de Poisson con parámetro λ.

Características:

Muy usada para modelar número de llegadas en un intervalo fijo.

Puede dar 0 → significa que llegan varias consultas en el mismo instante (ráfagas).

✅ Adecuada para: simular escenarios con llegadas más realistas que se concentran alrededor de un valor medio pero con variabilidad.
...
No da enteros → más realista para tiempo continuo.
